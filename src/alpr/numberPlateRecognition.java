...
public class numberPlateRecognition {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String country = "in", configfile = "E:\\openalpr-2.3.0\\openalpr_64\\openalpr.conf", runtimeDataDir = "E:\\openalpr-2.3.0\\openalpr train india\\openalpr-master\\runtime_data", licensePlate = "E:\\openalpr-2.3.0\\openalpr_64\\samples\\in5.jpg";
        /*if (args.length == 4) {
                country = args[0];
                configfile = args[1];
